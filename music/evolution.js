...
function generateRandomIndividual() {
  ...
  function playMusicPiece(musicPiece) {
    ...
    musicPiece.forEach((frequency, index) => {
      ...
      oscillator.frequency.setValueAtTime(frequency * 440, audioContext.currentTime + index);
  ...
  let population = Array.from({ length: populationSize }, generateRandomIndividual);
